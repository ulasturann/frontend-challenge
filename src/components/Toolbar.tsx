...
function Toolbar() {
  ...
  return (
    <div className="flex justify-content-between px-4 align-items-center surface-0 border-bottom-1 surface-border sticky top-0 z-3 shadow-0">
      <StyleClass
        nodeRef={btnRef1}
        selector="#sidebar"
        ...
        hideOnOutsideClick
      >
        <a ref={btnRef1} className="cursor-pointer block lg:hidden">
